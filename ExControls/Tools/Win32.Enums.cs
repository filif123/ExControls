...
internal static partial class Win32
{
    ...
    {
        /// <summary>
        ///     The szPath and iIcon members of the <see cref="SHSTOCKICONINFO" /> structure receive the path and icon index
        ///     of the requested icon, in a format suitable for passing to the ExtractIcon function.
        ///     The numerical value of this flag is zero, so you always get the icon location regardless of other flags.
        /// </summary>
        SHGSI_ICONLOCATION = 0,

        /// <summary>
        ///     The hIcon member of the <see cref="SHSTOCKICONINFO" /> structure receives a handle to the specified icon.
        /// </summary>
        SHGSI_ICON = 0b_1_00000000,

        /// <summary>
        ///     The iSysImageImage member of the <see cref="SHSTOCKICONINFO" /> structure receives the index of the specified icon
        ///     in the system imagelist.
        /// </summary>
        SHGSI_SYSICONINDEX = 0b_01000000_00000000,

        /// <summary>
        ///     Modifies the SHGSI_ICON value by causing the function to add the link overlay to the file's icon.
        /// </summary>
        SHGSI_LINKOVERLAY = 0b_10000000_00000000,

        /// <summary>
        ///     Modifies the SHGSI_ICON value by causing the function to blend the icon with the system highlight color.
        /// </summary>
        SHGSI_SELECTED = 0b_1_00000000_00000000,

        /// <summary>
        ///     Modifies the SHGSI_ICON value by causing the function to retrieve the large version of the icon,
        ///     as specified by the SM_CXICON and SM_CYICON system metrics.
        /// </summary>
        SHGSI_LARGEICON = 0b000,
        ...
        /// </summary>
        SHGSI_SMALLICON = 0b001,

        /// <summary>
        ///     Modifies the SHGSI_LARGEICON or SHGSI_SMALLICON values by causing the function to
