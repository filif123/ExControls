...
public class ExRadioButton : RadioButton, IExControl, ICheckableExControl
{
    ...
    [ExDescription("Color of the RadioButton's border.")]
    ...
    [ExCategory(CategoryType.Appearance)]
    [DefaultValue(typeof(Color), "Black")]
    [ExDescription("Color of the RadioButton's mark.")]
    ...
    [ExDescription("Background color of RadioButton's circle.")]
    ...
    [ExDescription("Color of the border and mark of RadioButton when mouse is over the Control.")]
    ...
    protected virtual void OnDisabledForeColorChanged() => DisabledForeColorChanged?.Invoke(this, EventArgs.Empty);

    /// <summary>Raises the <see cref="BorderColorChanged" /> event.</summary>
    protected virtual void OnBorderColorChanged() => BorderColorChanged?.Invoke(this, EventArgs.Empty);

    /// <summary>Raises the <see cref="MarkColorChanged" /> event.</summary>
    protected virtual void OnMarkColorChanged() => MarkColorChanged?.Invoke(this, EventArgs.Empty);

    /// <summary>Raises the <see cref="BoxBackColorChanged" /> event.</summary>
    protected virtual void OnBoxBackColorChanged() => BoxBackColorChanged?.Invoke(this, EventArgs.Empty);

    /// <summary>Raises the <see cref="HighlightColorChanged" /> event.</summary>
    protected virtual void OnHighlightColorChanged() => HighlightColorChanged?.Invoke(this, EventArgs.Empty);
}